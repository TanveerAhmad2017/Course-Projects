...
namespace LibGreenDC
{
    ...
    public abstract class SchedulerBase
    {
        ...
        public virtual void ProcessJobList()
        {
            ...
            //if (this.SchedulerType == SchedulerType.LeadTimeFit)
            //{
        ...
        {
            for (int p = 0; p < job.ProcessingTime; p++)
            {
        ...
        {            
            ...
            //        Console.WriteLine("Drop job ID ={0}, Arr ={1}, Deadline ={2}, Node ={3}, ProcessTime ={4} Weight={5}", j.JobId, j.ArrivalTime, j.Deadline, j.RequiredNodes, j.ProcessingTime,j.Weight);
            //    });
