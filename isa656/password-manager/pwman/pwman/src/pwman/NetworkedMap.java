...
public class NetworkedMap extends AbstractMap<byte[],byte[]> {
  ...
  //added by xin
  static final byte TAG_NEGO	  = 125;
  static final byte TAG_SHAKE	  = 126;
  static final byte TAG_CHANGE_PWD = 127;
  static final byte TAG_MY_KEY	  = 124;
   ...
   *
   * @param commuKey the map key to remove
   * @return the value for that key, or null if the key wasn't in the
   * map, or if an error occurs
   */
