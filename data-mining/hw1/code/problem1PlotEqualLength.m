...
line( [2.738300,2.738300 ],[ 2.049900 , 7.713800],'linewidth' ,3)
line( [4.792650,4.792650 ],[ 2.049900 , 7.713800],'linewidth' ,3)
line( [6.847000,6.847000 ],[ 2.049900 , 7.713800],'linewidth' ,3)

line([ 0.683950 ,  6.847000], [ 2.049900, 2.049900],'Color', 'g', 'linewidth' ,3)
line([ 0.683950 ,  6.847000], [ 3.937867 ,3.937867 ],'Color', 'g', 'linewidth' ,3)
line([ 0.683950 ,  6.847000], [ 5.825833,5.825833],'Color', 'g', 'linewidth' ,3)
...
saveas(gca, strcat('..\figs\equal-length', '.eps'),'psc2') %Save figure 
saveas(gcf, strcat('..\figs\equal-length'), 'pdf') %Save figure
